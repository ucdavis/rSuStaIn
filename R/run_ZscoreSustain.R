#' @title Run Z-score SuStaIn Algorithm
#'
#' @description
#' Wrapper for pySuStaIn's ZscoreSustain class, which implements SuStaIn for 
#' continuous biomarker data using z-score models.
#'
...
#' @param ... additional arguments passed to pySuStaIn$ZscoreSustain()
#'
...
#' n_subjects <- 100
#' n_biomarkers <- 5
#' data <- matrix(rnorm(n_subjects * n_biomarkers), 
...
#'   dataset_name = "zscore_example"
#' )
#' }
run_ZscoreSustain <- function(
    data,
    biomarker_labels,
    N_startpoints = 25,
    N_S_max = 3,
