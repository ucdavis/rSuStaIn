# Run Z-score SuStaIn Algorithm

Wrapper for pySuStaIn's ZscoreSustain class, which implements SuStaIn
for continuous biomarker data using z-score models.
...
- ...:
  ...
  additional arguments passed to pySuStaIn\$ZscoreSustain()
